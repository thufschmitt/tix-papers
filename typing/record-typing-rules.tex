...
\begin{figure}
  ...
  \begin{mathpar}
    ...
    \and\inferrule{%
      ...
      Γ \tinfer e_1 . e_2 \text{ or } e_3 :
      \left( τ(s) \backslash \undefr \right) \vee σ
    }\lbl{IRGuardedAccessFinite}

    \and\inferrule{%
      Γ \tinfer e_1 : τ \\
      Γ \tinfer e_2 : s \\
      Γ \tcheck e_3 : σ \\
      τ(s)\backslash \undefr \subtype σ
    }{%
      Γ \tcheck e_1 . e_2 \text{ or } e_3 : σ
    }\lbl{CRGuardedAccessFinite}

    \and\inferrule{%
      Γ \tinfer e_1 : τ \\ Γ \tinfer e_2 : τ' \\
