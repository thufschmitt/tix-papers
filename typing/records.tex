...
\begin{mathpar}
  ...
  \and
  \inferrule{%
    \Γ \vdash e_1 : \bigvee\limits_{i=1}^n \τ_i \\ \Γ \vdash e_2 : \bigvee\limits_{i=1}^m \σ_i \\%
    \forall i \in \discrete{1}{n}, \τ_i \subtype \τ'_i \\
    \forall i \in \discrete{1}{m}, \σ_i \subtype \σ'_i \\
    \forall (i,j) \in \discrete{1}{n} \times \discrete{1}{m}, \τ'_i \orthsum_\undef \σ'j
  }{%
    \Γ \vdash e_1 \orthsum_\undef e_2 : \bigvee\limits_{(i,j) \in \discrete{1}{n} \times \discrete{1}{m}} \τ'_i \orthsum_\undef \σ'_j
  }
\end{mathpar}
